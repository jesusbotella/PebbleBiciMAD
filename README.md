...
**La [API no Oficial de Bicimad](https://github.com/cicloon/bicimad-api) no contiene datos actualizados porque utilizaba una API oculta de BiciMAD, con lo cual esta app es inservible. Si conoces otra fuente de datos que pudiera utilizar mándame un correo a jesus.botella@gmail.com**
